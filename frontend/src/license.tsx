...
export default function License() { 
   return (
      <div className="w-1/3 mx-auto text-gray-500" >
         <Typography className="text-[8px]" placeholder="">
         ...
         <Typography className="text-[8px]" placeholder="">
            This project incorporates content from Wiktionary, licensed under the Creative Commons Attribution-ShareAlike 4.0 International License (CC BY-SA 4.0). See the license terms at https://creativecommons.org/licenses/by-sa/4.0/.
         </Typography>
      </div>
   )
}